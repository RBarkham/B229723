...
##### Lets load our data, we'll be looking from June-December (Summer to winter) across 2023, and 2024. These data files are large, so it may take some time for the chunk to run. (Only doing 2024 for now)
...
##### Join our map and healthboard perscription data
```{r, message=FALSE}
