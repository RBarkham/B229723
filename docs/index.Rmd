...
map(data_list, ~problems(.x)) ### we can see that there is missing data for Sucralfate (Nu), on Row Number 150,115 in Nov_2023 (our 6th tibble, and our 6th month)
...
saveRDS(Final_data, here("Data/Final_data_server.rds"))
```
...
<iframe src="https://rbarkham.shinyapps.io/antibiotics_map/" 
        width="100%" height="2000px" style="border:1px solid red;">
</iframe>
